                        ...
                        <form id="settings" method="post" action="<?php echo e(route('settings.update', $settings->id)); ?>" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="nav-wrapper">
                                <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link mb-sm-3 mb-md-0 active" data-toggle="pill" href="#tabs-icons-text-1"><i class="ni ni-bullet-list-67 mr-2"></i><?php echo e(__ ('Site Info')); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-2-tab" data-toggle="pill" href="#tabs-icons-text-2" ><i class="ni ni-image mr-2"></i><?php echo e(__ ('Images')); ?></a>
                                    </li>
                                    ...
                                    <?php $__currentLoopData = $envConfigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupConfig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="nav-item">
                                            <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-2-tab" data-toggle="pill" href="#<?php echo e($groupConfig['slug']); ?>"><i class="<?php echo e($groupConfig['icon']); ?>"></i> <?php echo e(__ ($groupConfig['name'])); ?></a>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>


                                    <li class="nav-item">
                                        <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-2-tab" data-toggle="pill" href="#cssjs" ><i class="ni ni-palette mr-2"></i><?php echo e(__ ('CSS & JS')); ?></a>
                                    </li>
...
<?php echo $__env->make('layouts.app', ['title' => __('Settings')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wabizz1/public_html/resources/views/settings/index.blade.php ENDPATH**/ ?>