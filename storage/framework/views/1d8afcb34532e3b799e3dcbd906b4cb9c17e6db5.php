                            ...
                            <form method="post" action="<?php echo e(route('items.update', $item)); ?>" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php $image=['name'=>'item_image','label'=>__('Item Image'),'value'=> $item->logom[0],'style'=>'width: 290px; height:200']; ?>
                                        <?php echo $__env->make('partials.images',$image, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                                        <?php $image=['name'=>'item_image_two','label'=>__('Item Image'),'value'=> $item->logom[1],'style'=>'width: 290px; height:200']; ?>
                                        <?php echo $__env->make('partials.images',$image, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                                        <?php $image=['name'=>'item_image_three','label'=>__('Item Image'),'value'=> $item->logom[2],'style'=>'width: 290px; height:200']; ?>
                                        <?php echo $__env->make('partials.images',$image, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                                        <?php $image=['name'=>'item_image_four','label'=>__('Item Image'),'value'=> $item->logom[3],'style'=>'width: 290px; height:200']; ?>
                                        <?php echo $__env->make('partials.images',$image, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="modal fade" id="imagemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <img id="img_preview" src="#" alt="your image" style="width: 400px; height: 264px;" />
            </div>
    ...
    <script type="text/javascript">
        ...
        function previewFile(input){
            ...
            if(file){
                ...
                // $('#img_preview').attr('src', $('#input_file').attr('src'));
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wabi\resources\views/items/edit.blade.php ENDPATH**/ ?>