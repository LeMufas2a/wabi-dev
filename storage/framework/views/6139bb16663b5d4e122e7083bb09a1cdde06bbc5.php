    ...
    <div class="row">
      <div class="col-md-8 mx-auto text-center">
        ...
        <img class="img-thumbnail img-fluid rounded shadow" data-toggle="tooltip" data-placement="top"
          ...
          data-animation="true"
          src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo e($demoLink); ?>" />
        <!-- END DEMO QR-->
        <br /> <br />
        
        <a type="button" target="_blank" class="btn btn-outline-success" href="<?php echo e($demoLink); ?>"><?php echo e(__('whatsapp.test_on_web')); ?></a>
...
</div><?php /**PATH /home/wabizz1/public_html/resources/views/social/partials/demo.blade.php ENDPATH**/ ?>