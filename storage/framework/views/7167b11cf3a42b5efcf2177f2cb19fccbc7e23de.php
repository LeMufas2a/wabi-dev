                    ...
                    <div class="text-95 text-secondary-d3">
                        ...
                        <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?> 
                                ...
                                <div class="d-none d-sm-block col-2 text-95"><?php echo money($theItemPrice, $currency,$convert); ?></div>
                                <div class="col-2 text-secondary-d2"><?php echo money($item->pivot->qty*$theItemPrice, $currency,$convert); ?></div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            ...
                            <?php if($order->discount>0): ?>
                                <div class="row my-2">
                                    ...
                                    <div class="col-5">
                                        <span class="text-110"><?php echo money($order->discount, $currency,$convert); ?></span>
                                    </div>
                                </div>
                            <?php endif; ?>
                             ...
                             <div class="row my-2">
                                ...
                                <div class="col-5">
                                    <b><span class="text-110 text-success-d3"><?php echo money($order->delivery_price+$order->order_price_with_discount, $currency,true); ?></span></b>
                                </div>
                            </div>
...
<?php echo $__env->make('pdf-invoice::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wabizz1/public_html/modules/PdfInvoice/Providers/../Resources/views/index.blade.php ENDPATH**/ ?>