                ...
                <div class='row mt-3'>
                    ...
                    <?php $__currentLoopData = $category->aitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-3" style="width: 18rem;">
                                <?php $__currentLoopData = $item->logom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img class="card-img-top" src="<?php echo e($value); ?>" alt="...">
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</section><?php /**PATH C:\xampp\htdocs\wabi\modules\ElegantTemplate\Providers/../Resources/views/templates/place-content.blade.php ENDPATH**/ ?>