...
class ServiceItem extends Model
{
    ...
    public $translatable = ['service_name', 'service_description'];
    ...
    protected $fillable = ['service_name', 'service_description', 'service_image', 'service_price', 'service_category_id', 'vat','enable_system_variants'];
    ...
    {
        return $this->getImge($this->service_image, config('global.restorant_details_image'));
    }

    public function getIconAttribute()
    {
        return $this->getImge($this->service_image, config('global.restorant_details_image'), '_thumbnail.jpg');
    }

    public function getItempriceAttribute()
    {
        return  Money($this->service_price, config('settings.cashier_currency'), config('settings.do_convertion'))->format();
    }

    public function getShortDescriptionAttribute()
    {
        return  $this->substrwords($this->service_description, config('settings.chars_in_menu_list'));
    }
    ...
    // My custom relations for calender or hours

    public function service_hours()
    {
        return $this->hasMany(\App\Models\ServiceHours::class,'service_item_id','id');
    }
}
